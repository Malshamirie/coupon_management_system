<!-- Modal -->
<div class="modal fade" id="delete_group{{ $group->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title fs-5" id="exampleModalLabel">
          {{ __('back.delete_group') }}
        </h5>
      ...
      <div class="modal-body">
        <form action="{{ route('admin.groups.destroy', $group->id) }}" method="post">
          ...
          <div class="text-center">
            <h4>
              {{ trans('back.Are_you_sure_to_delete') }} {{ $group->name }}
            </h4>
          </div>
