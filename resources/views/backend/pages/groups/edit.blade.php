<!-- Modal -->
<div class="modal fade" id="edit_group{{ $group->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title fs-5" id="exampleModalLabel">
          {{ __('back.edit_group') }} / {{ $group->name }}
        </h5>
          ...
          <div class="row">
            <div class="col-md-12 mb-3">
              ...
              <input type="text" value="{{ $group->name }}" class="form-control"
                placeholder="{{ __('back.group_name') }}" name="name" required>
            </div>
          </div>
