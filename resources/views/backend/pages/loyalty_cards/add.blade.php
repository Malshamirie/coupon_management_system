<!-- Modal -->
<div class="modal fade" id="add_loyalty_card" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('admin.loyalty_cards.store') }}" method="post" enctype="multipart/form-data">
          @csrf
          
          <div class="row">
            <div class="col-md-6 mb-3">
              <label class="form-label">{{ __('back.card_name') }} <span class="text-danger">*</span></label>
              <input type="text" class="form-control" placeholder="{{ __('back.card_name') }}" name="name"
                required>
            </div>
            <div class="col-md-6 mb-3">
          ...
          <div class="row">
            <div class="col-md-12 mb-3">
              ...
              <textarea class="form-control" rows="3" placeholder="{{ __('back.card_description') }}" name="description"></textarea>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 mb-3">
