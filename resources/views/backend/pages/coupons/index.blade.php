    ...
    <div class="row" id="table-bordered">
        ...
        @can('coupons')
            <div class="col-md-6 mb-1 ">
                <form action="{{ route('admin.coupons.index') }}" method="GET" role="search">
                    <div class="input-group">
                        ...
                        <a href="{{ route('admin.coupons.index') }}" class="btn btn-success btn-sm ml-1" title="Reload">
