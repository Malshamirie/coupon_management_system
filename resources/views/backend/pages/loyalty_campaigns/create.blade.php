                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="loyalty_card_id">{{ __('back.card_type') }} <span
                                            class="text-danger">*</span></label>
                                    <select name="loyalty_card_id" id="loyalty_card_id"
                                        class="form-control @error('loyalty_card_id') is-invalid @enderror" required>
                                        <option value="">{{ __('back.select_card_type') }}</option>
                                        @foreach ($loyaltyCards as $card)
                                            <option value="{{ $card->id }}"
                                                {{ old('loyalty_card_id') == $card->id ? 'selected' : '' }}>
                                                {{ $card->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="loyalty_container_id">{{ __('back.container') }} <span
                                            class="text-danger">*</span></label>
                                    <select name="loyalty_container_id" id="loyalty_container_id"
                                        class="form-control @error('loyalty_container_id') is-invalid @enderror" required>
                                        <option value="">{{ __('back.select_container') }}</option>
                                        @foreach ($loyaltyContainers as $loyaltyContainer)
                                            <option value="{{ $loyaltyContainer->id }}"
                                                {{ old('loyalty_container_id') == $loyaltyContainer->id ? 'selected' : '' }}>
                                                {{ $loyaltyContainer->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('loyalty_container_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="campaign_name">{{ __('back.campaign_name') }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="manager_name">{{ __('back.manager_name') }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="start_date">{{ __('back.start_date') }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="end_date">{{ __('back.end_date') }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sending_method">{{ __('back.sending_method') }} <span
                                            class="text-danger">*</span></label>
                                    <select name="sending_method" id="sending_method"
                                        class="form-control @error('sending_method') is-invalid @enderror" required>
                                        {{-- <option value="">{{ __('back.select_sending_method') }}</option> --}}
                                        <option value="whatsapp"
                                            {{ old('sending_method') == 'whatsapp' ? 'selected' : '' }}>WhatsApp</option>
                            ...
                            <div class="col-md-6 whatsapp-fields">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="whatsapp_template_id" id="whatsapp_template_id"
                                        class="form-control @error('whatsapp_template_id') is-invalid @enderror"
                            ...
                            <div class="col-md-6 whatsapp-fields">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="whatsapp_image_url" id="whatsapp_image_url"
                                        class="form-control @error('whatsapp_image_url') is-invalid @enderror"
                            ...
                            <div class="col-md-12 email-fields" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <textarea name="email_template" id="email_template" rows="5"
                                        class="form-control @error('email_template') is-invalid @enderror">{{ old('email_template') }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="additional_terms" id="additional_terms" rows="3"
                                        class="form-control @error('additional_terms') is-invalid @enderror">{{ old('additional_terms') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="page_logo" id="page_logo"
                                        class="form-control @error('page_logo') is-invalid @enderror" accept="image/*">
                                    @error('page_logo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="main_text" id="main_text" rows="3"
                                        class="form-control @error('main_text') is-invalid @enderror">{{ old('main_text') }}</textarea>
                                    @error('main_text')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="sub_text" id="sub_text" rows="3"
                                        class="form-control @error('sub_text') is-invalid @enderror">{{ old('sub_text') }}</textarea>
                                    @error('sub_text')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="after_form_text" id="after_form_text" rows="3"
                                        class="form-control @error('after_form_text') is-invalid @enderror">{{ old('after_form_text') }}</textarea>
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                ...
                                <a href="{{ route('admin.loyalty_campaigns.index') }}"
                                    class="btn btn-secondary">{{ __('back.cancel') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
