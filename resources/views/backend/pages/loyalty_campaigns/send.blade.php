    ...
    $(document).ready(function() {
      ...
      $('#confirm-send').click(function() {
        ...
        $(this).prop('disabled', true).html(
          '<i class="fas fa-spinner fa-spin"></i> {{ __('back.processing') }}');
        ...
        $.ajax({
          ...
          success: function(response) {
            // إزالة التركيز من الزر قبل إغلاق modal
            $('#confirm-send').blur();
          ...
          error: function(xhr) {
            ...
            $('#confirm-send').prop('disabled', false).html('{{ __('back.confirm_send') }}');

            var errorMessage = '{{ __('back.error_occurred') }}';
