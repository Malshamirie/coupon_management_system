<!-- Modal -->
<div class="modal fade" id="delete_campaign{{$campaign->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fs-5" id="exampleModalLabel">
                    {{ __('back.delete_campaign') }}
                </h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{route('admin.campaigns.destroy', $campaign->id)}}" method="post">
                    ...
                    <div class="text-center" >
                        ...
                        <h4>
                            {{trans('back.Are_you_sure_to_delete')}} {{ $campaign->campaign_name}}
                        </h4>
                    </div>
