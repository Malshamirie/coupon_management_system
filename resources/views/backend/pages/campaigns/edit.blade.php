...
@section('page_title', __('back.edit_campaign'))
@section('title', __('back.edit_campaign'))
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> تعديل حملة </li>
    </ol>
</nav>
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.campaigns.update', $campaign->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    <label for="name" class="form-label">{{ __('back.name') }} <span class="text-danger">*</span></label>
                ...
                <div class="col-md-4 mb-3">
                    <label for="end_date" class="form-label">{{ __('back.end_date') }} <span class="text-danger">*</span></label>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="manager_name" id="manager_name" class="form-control"
                        value="{{ old('manager_name', $campaign->manager_name) }}" required>
                    @error('manager_name')<small class="text-danger">{{ $message }}</small>@enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="coupon_type" id="coupon_type" class="form-select" required>
                        <option value="" disabled {{ old('coupon_type', $campaign->coupon_type) ? '' : 'selected' }}>
                            {{ __('back.select_coupon_type') }}</option>
                        <option value="fixed" {{ old('coupon_type', $campaign->coupon_type) == 'fixed' ? 'selected' : '' }}>
                            {{ __('back.fixed_value') }}</option>
                        <option value="percentage" {{ old('coupon_type', $campaign->coupon_type) == 'percentage' ? 'selected' : '' }}>
                            {{ __('back.percentage') }}</option>
                        <option value="cashback" {{ old('coupon_type', $campaign->coupon_type) == 'cashback' ? 'selected' : '' }}>
                            {{ __('back.cashback') }}</option>
                        <option value="second_invoice_discount"
                            {{ old('coupon_type', $campaign->coupon_type) == 'second_invoice_discount' ? 'selected' : '' }}>
                            {{ __('back.second_invoice_discount') }}</option>
                    </select>
                    @error('coupon_type')<small class="text-danger">{{ $message }}</small>@enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="search_method" id="search_method" class="form-select" required>
                        <option value="" disabled {{ old('search_method', $campaign->search_method) ? '' : 'selected' }}>
                            {{ __('back.select_search_method') }}</option>
                        <option value="phone" {{ old('search_method', $campaign->search_method) == 'phone' ? 'selected' : '' }}>
                            {{ __('back.phone') }}</option>
                        <option value="email" {{ old('search_method', $campaign->search_method) == 'email' ? 'selected' : '' }}>
                            {{ __('back.email') }}</option>
                    </select>
                    @error('search_method')<small class="text-danger">{{ $message }}</small>@enderror
                </div>

                <div class="col-md-4 mb-3" id="email_domain_div" style="{{ old('search_method', $campaign->search_method) == 'email' ? 'display:block' : 'display:none' }}">
                    ...
                    <input type="text" name="email_domain" id="email_domain" class="form-control"
                        value="{{ old('email_domain', $campaign->email_domain) }}"
                        placeholder="{{ __('back.email_domain_placeholder') }}">
                    @error('email_domain')<small class="text-danger">{{ $message }}</small>@enderror
                </div>

                <div class="col-md-4 mb-3" id="otp_required_div" style="{{ old('search_method', $campaign->search_method) == 'email' ? 'display:block' : 'display:none' }}">
                    <div class="form-check mt-4">
                        <input type="checkbox" name="otp_required" value="1" id="otp_required" class="form-check-input"
                            {{ old('otp_required', $campaign->otp_required) ? 'checked' : '' }}>
                        <label for="otp_required" class="form-check-label">{{ __('back.otp_required') }}</label>
                    </div>
                </div>

                    <div class="col-md-4 mb-3" id="whatsapp_template_div" style="{{ old('search_method', $campaign->search_method) == 'phone' ? 'display:block' : 'display:none' }}">
                        ...
                        <input type="text" name="id_template" id="id_template" class="form-control"
                            value="{{ old('id_template', $campaign->id_template) }}">
                        @error('id_template')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>

                    <div class="col-md-4 mb-3" id="whatsapp_image_div" style="{{ old('search_method', $campaign->search_method) == 'email' ? 'display:block' : 'display:none' }}">
                        ...
                        <input type="text" name="whatsapp_image_url" id="whatsapp_image_url" class="form-control"
                            value="{{ old('whatsapp_image_url', $campaign->whatsapp_image_url) }}">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="beneficiary" id="beneficiary" class="form-control"
                        value="{{ old('beneficiary', $campaign->beneficiary) }}">
                    @error('beneficiary')<small class="text-danger">{{ $message }}</small>@enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="beneficiary_manager" id="beneficiary_manager" class="form-control"
                        value="{{ old('beneficiary_manager', $campaign->beneficiary_manager) }}">
                    @error('beneficiary_manager')<small class="text-danger">{{ $message }}</small>@enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="beneficiary_contact" id="beneficiary_contact" class="form-control"
                        value="{{ old('beneficiary_contact', $campaign->beneficiary_contact) }}">
                    @error('beneficiary_contact')<small class="text-danger">{{ $message }}</small>@enderror
                </div>

                <div class="col-md-12 mb-3">
                    <label for="terms" class="form-label">{{ __('back.additional_terms') }}</label>
                    <textarea name="terms" id="terms" rows="4" class="form-control">{{ old('terms', $campaign->terms) }}</textarea>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    <label for="logo" class="form-label">{{ __('back.logo') }}</label>
                        <div class="input-group">
                            ...
                            <img src="{{ asset($campaign->logo) }}"  class="avatar-sm  me-2 ml-1 mr-1">
                        </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="main_text" id="main_text" class="form-control"
                        value="{{ old('main_text', $campaign->main_text) }}">
                    @error('main_text')<small class="text-danger">{{ $message }}</small>@enderror
                </div>

                <div class="col-md-4 mb-3">
                    <label for="sub_text" class="form-label">{{ __('back.sub_text') }}</label>
                    <input type="text" name="sub_text" id="sub_text" class="form-control"
                        value="{{ old('sub_text', $campaign->sub_text) }}">
                    @error('sub_text')<small class="text-danger">{{ $message }}</small>@enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="footer_text" id="footer_text" class="form-control"
                        value="{{ old('footer_text', $campaign->footer_text) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="url" name="redirect" id="redirect" class="form-control"
                        value="{{ old('redirect', $campaign->redirect) }}" placeholder="https://example.com">
                    @error('redirect')<small class="text-danger">{{ $message }}</small>@enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="container_id" id="container_id" class="form-select" required>
                        <option value="" disabled {{ $campaign->container_id ? '' : 'selected' }}>{{ __('back.select_container') }}</option>
                        @foreach ($containers as $container)
                            <option value="{{ $container->id }}" {{ old('container_id', $campaign->container_id) == $container->id ? 'selected' : '' }}>
                                {{ $container->name }}
                            </option>
                        @endforeach
                    </select>
                    @error('container_id')<small class="text-danger">{{ $message }}</small>@enderror
                </div>
            </div>

            <div class="mt-4 text-center">
                <button type="submit" class="btn btn-primary">{{ __('back.update') }}</button>
